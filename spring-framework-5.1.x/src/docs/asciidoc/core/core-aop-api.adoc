...
in the `com.spring.mvc.controller.DemoController.mycompany.web` package or by the `SomeCaller` class. Control flow pointcuts
...
[subs="verbatim,quotes"]
----
	<bean id="personTarget" class="com.spring.mvc.controller.DemoController.mycompany.PersonImpl">
		<property name="name" value="Tony"/>
		<property name="age" value="51"/>
	</bean>

	<bean id="myAdvisor" class="com.spring.mvc.controller.DemoController.mycompany.MyAdvisor">
	...
	<bean id="person"
		...
		<property name="proxyInterfaces" value="com.spring.mvc.controller.DemoController.mycompany.Person"/>
...
[subs="verbatim,quotes"]
----
	<bean id="personUser" class="com.spring.mvc.controller.DemoController.mycompany.PersonUser">
...
----
	...
	<bean id="person" class="org.springframework.aop.framework.ProxyFactoryBean">
		...
		<property name="target">
			<bean class="com.spring.mvc.controller.DemoController.mycompany.PersonImpl">
				<property name="name" value="Tony"/>
				<property name="age" value="51"/>
			</bean>
		</property>
...
----
	...
	<bean id="customAdvisor" class="com.spring.mvc.controller.DemoController.mycompany.MyAdvisor"/>

	<bean id="businessObject1" class="com.spring.mvc.controller.DemoController.mycompany.BusinessObject1">
		<!-- Properties omitted -->
	</bean>

	<bean id="businessObject2" class="com.spring.mvc.controller.DemoController.mycompany.BusinessObject2"/>
----
====
...
[subs="verbatim,quotes"]
----
	<bean id="businessObjectTarget" class="com.spring.mvc.controller.DemoController.mycompany.MyBusinessObject"
			scope="prototype">
		... properties omitted
	</bean>
