...
----
	...
	@Pointcut("within(com.spring.mvc.controller.DemoController.xyz.someapp.trading..*)")
...
[subs="verbatim"]
----
	package com.spring.mvc.controller.DemoController.xyz.someapp;
	...
	public class SystemArchitecture {
		 ...
		 * in a type in the com.spring.mvc.controller.DemoController.xyz.someapp.web package or any sub-package
		 * under that.
		 */
		@Pointcut("within(com.spring.mvc.controller.DemoController.xyz.someapp.web..*)")
		public void inWebLayer() {}

		/**
		 * A join point is in the service layer if the method is defined
		 * in a type in the com.spring.mvc.controller.DemoController.xyz.someapp.service package or any sub-package
		 * under that.
		 */
		@Pointcut("within(com.spring.mvc.controller.DemoController.xyz.someapp.service..*)")
		public void inServiceLayer() {}

		/**
		 * A join point is in the data access layer if the method is defined
		 * in a type in the com.spring.mvc.controller.DemoController.xyz.someapp.dao package or any sub-package
		 * under that.
		 */
		@Pointcut("within(com.spring.mvc.controller.DemoController.xyz.someapp.dao..*)")
		 ...
		 * in packages com.spring.mvc.controller.DemoController.xyz.someapp.abc.service and com.spring.mvc.controller.DemoController.xyz.someapp.def.service) then
		 * the pointcut expression "execution(* com.spring.mvc.controller.DemoController.xyz.someapp..service.*.*(..))"
		 ...
		 */
		@Pointcut("execution(* com.spring.mvc.controller.DemoController.xyz.someapp..service.*.*(..))")
		 ...
		 */
		@Pointcut("execution(* com.spring.mvc.controller.DemoController.xyz.someapp.dao.*.*(..))")
...
----
	<aop:config>
		<aop:advisor
			pointcut="com.spring.mvc.controller.DemoController.xyz.someapp.SystemArchitecture.businessService()"
...
[subs="verbatim"]
----
	execution(* com.spring.mvc.controller.DemoController.xyz.service.AccountService.*(..))
----
====
...
[subs="verbatim"]
----
	execution(* com.spring.mvc.controller.DemoController.xyz.service.*.*(..))
----
====
...
[subs="verbatim,quotes"]
----
	within(com.spring.mvc.controller.DemoController.xyz.service.*)
----
====
...
[subs="verbatim,quotes"]
----
	this(com.spring.mvc.controller.DemoController.xyz.service.AccountService)
----
====
+
...
[subs="verbatim,quotes"]
----
	target(com.spring.mvc.controller.DemoController.xyz.service.AccountService)
----
====
+
...
[subs="verbatim,quotes"]
----
	@args(com.spring.mvc.controller.DemoController.xyz.security.Classified)
----
====
+
...
----
	...
	public class BeforeExample {
		...
		@Before("com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.dataAccessOperation()")
...
----
	...
	public class BeforeExample {
		...
		@Before("execution(* com.spring.mvc.controller.DemoController.xyz.myapp.dao.*.*(..))")
		public void doAccessCheck() {
			// ...
		}
...
----
	...
	public class AfterReturningExample {
		...
		@AfterReturning("com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.dataAccessOperation()")
		public void doAccessCheck() {
			// ...
		}
...
----
	...
	public class AfterReturningExample {
		...
		@AfterReturning(
			pointcut="com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.dataAccessOperation()",
			returning="retVal")
...
----
	...
	public class AfterThrowingExample {
		...
		@AfterThrowing("com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.dataAccessOperation()")
...
----
	...
	public class AfterFinallyExample {
		...
		@After("com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.dataAccessOperation()")
...
----
	...
	public class AroundExample {
		...
		@Around("com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.businessService()")
...
[subs="verbatim,quotes"]
----
	@Before("com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.dataAccessOperation() && args(account,..)")
...
[subs="verbatim,quotes"]
----
	@Pointcut("com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.dataAccessOperation() && args(account,..)")
...
[subs="verbatim,quotes"]
----
	@Before("com.spring.mvc.controller.DemoController.xyz.lib.Pointcuts.anyPublicMethod() && @annotation(auditable)")
...
[subs="verbatim,quotes"]
----
	@Before(value="com.spring.mvc.controller.DemoController.xyz.lib.Pointcuts.anyPublicMethod() && target(bean) && @annotation(auditable)",
...
[subs="verbatim,quotes"]
----
	@Before("com.spring.mvc.controller.DemoController.xyz.lib.Pointcuts.anyPublicMethod()")
...
----
	@Around("execution(List<Account> find*(..)) && " +
			"com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.inDataAccessLayer() && " +
...
----
	...
	public class UsageTracking {
		...
		@DeclareParents(value="com.spring.mvc.controller.DemoController.xzy.myapp.service.*+", defaultImpl=DefaultUsageTracked.class)
		public static UsageTracked mixin;

		@Before("com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.businessService() && this(usageTracked)")
...
[subs="verbatim,quotes"]
----
	@Aspect("perthis(com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.businessService())")
	public class MyAspect {

		private int someState;

		@Before(com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.businessService())
...
----
	...
	<bean id="concurrentOperationExecutor" class="com.spring.mvc.controller.DemoController.xyz.myapp.service.impl.ConcurrentOperationExecutor">
...
----
	@Around("com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.businessService() && " +
			"@annotation(com.spring.mvc.controller.DemoController.xyz.myapp.service.Idempotent)")
	public Object doConcurrentOperation(ProceedingJoinPoint pjp) throws Throwable {
		...
	}
----
...
----
	<aop:config>
		...
		<aop:pointcut id="businessService"
			expression="execution(* com.spring.mvc.controller.DemoController.xyz.myapp.service.*.*(..))"/>
...
----
	<aop:config>
		...
		<aop:pointcut id="businessService"
			expression="com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.businessService()"/>
...
----
	<aop:config>
		...
		<aop:aspect id="myAspect" ref="aBean">
			...
			<aop:pointcut id="businessService"
				expression="execution(* com.spring.mvc.controller.DemoController.xyz.myapp.service.*.*(..)) &amp;&amp; this(service)"/>
...
----
	<aop:config>
		...
		<aop:aspect id="myAspect" ref="aBean">
			...
			<aop:pointcut id="businessService"
				expression="execution(* com.spring.mvc.controller.DemoController.xyz.myapp.service.*.*(..)) and this(service)"/>
...
----
	<aop:aspect id="beforeExample" ref="aBean">
		...
		<aop:before
			pointcut="execution(* com.spring.mvc.controller.DemoController.xyz.myapp.dao.*.*(..))"
			method="doAccessCheck"/>
...
----
	<aop:before
		pointcut="com.spring.mvc.controller.DemoController.xyz.lib.Pointcuts.anyPublicMethod() and @annotation(auditable)"
		method="audit"
		arg-names="auditable"/>
----
====
...
----
	<aop:aspect id="usageTrackerAspect" ref="usageTracking">
		...
		<aop:declare-parents
			types-matching="com.spring.mvc.controller.DemoController.xzy.myapp.service.*+"
			implement-interface="com.spring.mvc.controller.DemoController.xyz.myapp.service.tracking.UsageTracked"
			default-impl="com.spring.mvc.controller.DemoController.xyz.myapp.service.tracking.DefaultUsageTracked"/>

		<aop:before
			pointcut="com.spring.mvc.controller.DemoController.xyz.myapp.SystemArchitecture.businessService()
...
----
	...
	<bean id="concurrentOperationExecutor"
		class="com.spring.mvc.controller.DemoController.xyz.myapp.service.impl.ConcurrentOperationExecutor">
			<property name="maxRetries" value="3"/>
			<property name="order" value="100"/>
	</bean>
----
...
----
	<aop:pointcut id="idempotentOperation"
			expression="execution(* com.spring.mvc.controller.DemoController.xyz.myapp.service.*.*(..)) and
			@annotation(com.spring.mvc.controller.DemoController.xyz.myapp.service.Idempotent)"/>
----
====
...
[subs="verbatim,quotes"]
----
	package com.spring.mvc.controller.DemoController.xyz.myapp.domain;
...
(`com.spring.mvc.controller.DemoController.xyz.myapp.domain.Account`). Since the default name for a bean is the
...
[subs="verbatim,quotes"]
----
	<bean class="com.spring.mvc.controller.DemoController.xyz.myapp.domain.Account" scope="prototype">
...
https://docs.oracle.com.spring.mvc.controller.DemoController/javase/8/docs/api/java/io/Serializable.html[readResolve()]).
...
----
	<bean id="myService"
			class="com.spring.mvc.controller.DemoController.xzy.myapp.service.MyService"
...
[subs="verbatim,quotes"]
----
	<bean id="profiler" class="com.spring.mvc.controller.DemoController.xyz.profiler.Profiler"
...
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-petclinic[Petclinic sample application].
...
https://docs.oracle.com.spring.mvc.controller.DemoController/javase/8/docs/api/java/lang/instrument/package-summary.html[agents
...
| Running in IBM's https://www-01.ibm.com.spring.mvc.controller.DemoController/software/webservers/appserv/was/[WebSphere]
| `WebSphereLoadTimeWeaver`

| Running in Oracle's
  https://www.oracle.com.spring.mvc.controller.DemoController/technetwork/middleware/weblogic/overview/index-085209.html[WebLogic]
