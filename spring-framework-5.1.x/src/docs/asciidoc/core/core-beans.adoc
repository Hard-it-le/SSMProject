...
For example, if you have a class called `SomeThing` in the `com.spring.mvc.controller.DemoController.example` package, and this
`SomeThing` class has a `static` nested class called `OtherThing`, the value of the `class`
attribute on a bean definition would be `com.spring.mvc.controller.DemoController.example.SomeThing$OtherThing`.
...
https://download.oracle.com.spring.mvc.controller.DemoController/javase/8/docs/api/java/beans/ConstructorProperties.html[@ConstructorProperties]
...
----
	<bean id="myDataSource" class="org.apache.commons.dbcp.BasicDataSource" destroy-method="close">
		...
		<property name="driverClassName" value="com.spring.mvc.controller.DemoController.mysql.jdbc.Driver"/>
...
----
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<bean id="myDataSource" class="org.apache.commons.dbcp.BasicDataSource"
			...
			p:driverClassName="com.spring.mvc.controller.DemoController.mysql.jdbc.Driver"
...
design time, unless you use an IDE (such as https://www.jetbrains.com.spring.mvc.controller.DemoController/idea/[IntelliJ
...
----
	<bean id="mappings"
		...
		<property name="properties">
			<value>
				jdbc.driver.className=com.spring.mvc.controller.DemoController.mysql.jdbc.Driver
...
----
	...
	<bean id="accountService" class="com.spring.mvc.controller.DemoController.something.SimpleAccountService">
...
----
	<bean id="outer" class="...">
		...
		<property name="target">
			<bean class="com.spring.mvc.controller.DemoController.example.Person"> <!-- this is the inner bean -->
...
----
	<beans>
		<bean id="parent" abstract="true" class="example.ComplexObject">
			<property name="adminEmails">
				<props>
					<prop key="administrator">administrator@example.com.spring.mvc.controller.DemoController</prop>
					<prop key="support">support@example.com.spring.mvc.controller.DemoController</prop>
				</props>
			</property>
		</bean>
		<bean id="child" parent="parent">
			<property name="adminEmails">
				...
				<props merge="true">
					<prop key="sales">sales@example.com.spring.mvc.controller.DemoController</prop>
...
[subs="verbatim,quotes"]
----
administrator=administrator@example.com.spring.mvc.controller.DemoController
sales=sales@example.com.spring.mvc.controller.DemoController
...
----
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<bean name="classic" class="com.spring.mvc.controller.DemoController.example.ExampleBean">
			<property name="email" value="someone@somewhere.com.spring.mvc.controller.DemoController"/>
		</bean>

		<bean name="p-namespace" class="com.spring.mvc.controller.DemoController.example.ExampleBean"
			p:email="someone@somewhere.com.spring.mvc.controller.DemoController"/>
	</beans>
----
====
...
----
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<bean name="john-classic" class="com.spring.mvc.controller.DemoController.example.Person">
			<property name="name" value="John Doe"/>
			<property name="spouse" ref="jane"/>
		</bean>

		<bean name="john-modern"
			class="com.spring.mvc.controller.DemoController.example.Person"
			p:name="John Doe"
			p:spouse-ref="jane"/>

		<bean name="jane" class="com.spring.mvc.controller.DemoController.example.Person">
...
----
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<bean id="beanOne" class="x.y.ThingOne">
			...
			<constructor-arg name="email" value="something@somewhere.com.spring.mvc.controller.DemoController"/>
		</bean>

		<!-- c-namespace declaration with argument names -->
		<bean id="beanOne" class="x.y.ThingOne" c:thingTwo-ref="beanTwo"
			c:thingThree-ref="beanThree" c:email="something@somewhere.com.spring.mvc.controller.DemoController"/>
...
----
	...
	<bean id="beanOne" class="x.y.ThingOne" c:_0-ref="beanTwo" c:_1-ref="beanThree"
		c:_2="something@somewhere.com.spring.mvc.controller.DemoController"/>
----
====
...
[subs="verbatim,quotes"]
----
	<bean id="lazy" class="com.spring.mvc.controller.DemoController.something.ExpensiveToCreateBean" lazy-init="true"/>
	<bean name="not.lazy" class="com.spring.mvc.controller.DemoController.something.AnotherBean"/>
----
====
...
[subs="verbatim,quotes"]
----
	<bean id="accountService" class="com.spring.mvc.controller.DemoController.something.DefaultAccountService"/>

	<!-- the following is equivalent, though redundant (singleton scope is the default) -->
	<bean id="accountService" class="com.spring.mvc.controller.DemoController.something.DefaultAccountService" scope="singleton"/>
----
====
...
[subs="verbatim,quotes"]
----
	<bean id="accountService" class="com.spring.mvc.controller.DemoController.something.DefaultAccountService" scope="prototype"/>
----
====
...
[subs="verbatim,quotes"]
----
	<bean id="loginAction" class="com.spring.mvc.controller.DemoController.something.LoginAction" scope="request"/>
----
====
...
[subs="verbatim,quotes"]
----
	<bean id="userPreferences" class="com.spring.mvc.controller.DemoController.something.UserPreferences" scope="session"/>
----
====
...
[subs="verbatim,quotes"]
----
	<bean id="appPreferences" class="com.spring.mvc.controller.DemoController.something.AppPreferences" scope="application"/>
----
====
...
----
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<bean id="userService" class="com.spring.mvc.controller.DemoController.something.SimpleUserService">
...
----
	...
	<bean id="userManager" class="com.spring.mvc.controller.DemoController.something.UserManager">
		<property name="userPreferences" ref="userPreferences"/>
	</bean>
----
====
...
----
	...
	<bean id="userPreferences" class="com.spring.mvc.controller.DemoController.stuff.DefaultUserPreferences" scope="session">
		<aop:scoped-proxy proxy-target-class="false"/>
	</bean>

	<bean id="userManager" class="com.spring.mvc.controller.DemoController.stuff.UserManager">
		<property name="userPreferences" ref="userPreferences"/>
	</bean>
----
====
...
----
	<beans default-init-method="init">
		...
		<bean id="blogService" class="com.spring.mvc.controller.DemoController.something.DefaultBlogService">
...
----
	<bean class="org.springframework.beans.factory.config.PropertyPlaceholderConfigurer">
		<property name="locations" value="classpath:com.spring.mvc.controller.DemoController/something/jdbc.properties"/>
	</bean>
...
[subs="verbatim,quotes"]
----
	<context:property-placeholder location="classpath:com.spring.mvc.controller.DemoController/something/jdbc.properties"/>
----
====
...
----
	<bean class="org.springframework.beans.factory.config.PropertyPlaceholderConfigurer">
		<property name="locations">
			<value>classpath:com.spring.mvc.controller.DemoController/something/strategy.properties</value>
		</property>
		<property name="properties">
			<value>custom.strategy.class=com.spring.mvc.controller.DemoController.something.DefaultStrategy</value>
		</property>
	</bean>
...
[subs="verbatim,quotes"]
----
dataSource.driverClassName=com.spring.mvc.controller.DemoController.mysql.jdbc.Driver
...
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/wiki/Spring-Annotation-Programming-Model[Spring Annotation Programming Model]
wiki page.
...
https://stackoverflow.com.spring.mvc.controller.DemoController/questions/19394570/java-jre-7u45-breaks-classloader-getresources).
...
| The JSR-330 default scope is like Spring's `prototype`. However, in order to keep it
  ...
  https://download.oracle.com.spring.mvc.controller.DemoController/javaee/6/api/javax/inject/Scope.html[@Scope] annotation.
...
----
	<beans>
		<bean id="myService" class="com.spring.mvc.controller.DemoController.acme.services.MyServiceImpl"/>
	</beans>
----
====
...
----
	@Configuration
	@ComponentScan(basePackages = "com.spring.mvc.controller.DemoController.acme") <1>
	public class AppConfig  {
		...
	}
----
...
----
	<beans>
		<context:component-scan base-package="com.spring.mvc.controller.DemoController.acme"/>
	</beans>
----
====
=====

In the preceding example, the `com.spring.mvc.controller.DemoController.acme` package is scanned to look for any
...
----
	public static void main(String[] args) {
		AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext();
		ctx.scan("com.spring.mvc.controller.DemoController.acme");
		ctx.refresh();
		MyService myService = ctx.getBean(MyService.class);
	}
----
...
assuming that `AppConfig` is declared within the `com.spring.mvc.controller.DemoController.acme` package (or any package
...
----
	<web-app>
		...
		<context-param>
			...
			<param-value>com.spring.mvc.controller.DemoController.acme.AppConfig</param-value>
		</context-param>
		...
		<servlet>
			...
			<init-param>
				<param-name>contextConfigLocation</param-name>
				<param-value>com.spring.mvc.controller.DemoController.acme.web.MvcConfig</param-value>
			</init-param>
		</servlet>
...
----
	<beans>
		<bean id="transferService" class="com.spring.mvc.controller.DemoController.acme.TransferServiceImpl"/>
	</beans>
----
====
...
[subs="verbatim,quotes"]
----
transferService -> com.spring.mvc.controller.DemoController.acme.TransferServiceImpl
----
====
...
----
	<beans>
		...
		<context:annotation-config/>
		<context:property-placeholder location="classpath:/com.spring.mvc.controller.DemoController/acme/jdbc.properties"/>

		<bean class="com.spring.mvc.controller.DemoController.acme.AppConfig"/>
...
----
	public static void main(String[] args) {
		ApplicationContext ctx = new ClassPathXmlApplicationContext("classpath:/com.spring.mvc.controller.DemoController/acme/system-test-config.xml");
		TransferService transferService = ctx.getBean(TransferService.class);
		// ...
	}
----
...
----
	@Configuration
	@ImportResource("classpath:/com.spring.mvc.controller.DemoController/acme/properties-config.xml")
	public class AppConfig {
...
----
	...
	public class StandaloneDataConfig {
		...
		public DataSource dataSource() {
			return new EmbeddedDatabaseBuilder()
				.setType(EmbeddedDatabaseType.HSQL)
				.addScript("classpath:com.spring.mvc.controller.DemoController/bank/config/sql/schema.sql")
				.addScript("classpath:com.spring.mvc.controller.DemoController/bank/config/sql/test-data.sql")
				.build();
		}
	}
----
...
----
	<beans profile="development"
		...
		<jdbc:embedded-database id="dataSource">
			<jdbc:script location="classpath:com.spring.mvc.controller.DemoController/bank/config/sql/schema.sql"/>
			<jdbc:script location="classpath:com.spring.mvc.controller.DemoController/bank/config/sql/test-data.sql"/>
...
----
   @Configuration
   @PropertySource("classpath:/com.spring.mvc.controller.DemoController/myco/app.properties")
   public class AppConfig {
...
----
   @Configuration
   @PropertySource("classpath:/com.spring.mvc.controller.DemoController/${my.placeholder:default/path}/app.properties")
   public class AppConfig {
...
----
	<beans>
		<import resource="com.spring.mvc.controller.DemoController/bank/service/${customer}-config.xml"/>
	</beans>
----
====
...
----
	<beans>
		...
		<bean id="example" class="com.spring.mvc.controller.DemoController.something.Example">
...
https://www.enterpriseintegrationpatterns.com.spring.mvc.controller.DemoController[pattern-oriented], event-driven
