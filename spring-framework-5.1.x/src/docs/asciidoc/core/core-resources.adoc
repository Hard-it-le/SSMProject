...
[subs="verbatim,quotes"]
----
	Resource template = ctx.getResource("https://myhost.com.spring.mvc.controller.DemoController/resource/path/myTemplate.txt");
----
====
...
| classpath:
| `classpath:com.spring.mvc.controller.DemoController/myapp/config.xml`
...
[subs="verbatim,quotes"]
----
com.spring.mvc.controller.DemoController/
  foo/
    services.xml
    daos.xml
...
----
/WEB-INF/*-context.xml
com.spring.mvc.controller.DemoController/mycompany/**/applicationContext.xml
file:C:/some/path/*-context.xml
classpath:com.spring.mvc.controller.DemoController/mycompany/**/applicationContext.xml
----
====
...
[subs="verbatim,quotes"]
----
com.spring.mvc.controller.DemoController/mycompany/package1/service-context.xml
----
====
...
[subs="verbatim,quotes"]
----
classpath:com.spring.mvc.controller.DemoController/mycompany/**/service-context.xml
----
...
`getResource("com.spring.mvc.controller.DemoController/mycompany");`. If this base package node exists in multiple
