...
https://www.atomikos.com.spring.mvc.controller.DemoController/[Atomikos Transactions] and http://jotm.objectweb.org/[JOTM])
...
| Comma-delimited list of `Exception` instances that trigger rollback. For example,
  `com.spring.mvc.controller.DemoController.foo.MyBusinessException,ServletException.`
...
name of the transaction would be: `com.spring.mvc.controller.DemoController.example.BusinessService.handlePayment`.
...
* https://www.javaworld.com.spring.mvc.controller.DemoController/javaworld/jw-01-2009/jw-01-spring-transactions.html[Distributed
...
* https://www.infoq.com.spring.mvc.controller.DemoController/minibooks/JTDS[_Java Transaction Design Strategies_] is a book
  available from https://www.infoq.com.spring.mvc.controller.DemoController/[InfoQ] that provides a well-paced introduction
...
----
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<bean id="corporateEventDao" class="com.spring.mvc.controller.DemoController.example.JdbcCorporateEventDao">
			<property name="dataSource" ref="dataSource"/>
		</bean>
...
adheres to https://www.oracle.com.spring.mvc.controller.DemoController/technetwork/java/javase/documentation/spec-136004.html[the
...
[subs="verbatim,quotes"]
----
	<bean id="dataSource" class="com.spring.mvc.controller.DemoController.mchange.v2.c3p0.ComboPooledDataSource" destroy-method="close">
...
----
	...
	import com.spring.mvc.controller.DemoController.foo.domain.Title;
...
----
	import java.sql.ResultSet;
	import java.sql.SQLException;
	import com.spring.mvc.controller.DemoController.foo.domain.Genre;
	import org.springframework.jdbc.core.RowMapper;
...
https://www.h2database.com.spring.mvc.controller.DemoController[H2], and https://db.apache.org/derby[Derby] is provided
...
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/issues[GitHub Issues].
...
----
	<jdbc:initialize-database data-source="dataSource">
		<jdbc:script location="classpath:com.spring.mvc.controller.DemoController/foo/sql/db-schema.sql"/>
		<jdbc:script location="classpath:com.spring.mvc.controller.DemoController/foo/sql/db-test-data.sql"/>
...
`classpath{asterisk}:/com.spring.mvc.controller.DemoController/foo/{asterisk}{asterisk}/sql/{asterisk}-data.sql`). If you use a
...
----
	<jdbc:initialize-database data-source="dataSource" separator="@@"> <1>
		<jdbc:script location="classpath:com.spring.mvc.controller.DemoController/myapp/sql/db-schema.sql" separator=";"/> <2>
		<jdbc:script location="classpath:com.spring.mvc.controller.DemoController/myapp/sql/db-test-data-1.sql"/>
		<jdbc:script location="classpath:com.spring.mvc.controller.DemoController/myapp/sql/db-test-data-2.sql"/>
	</jdbc:initialize-database>
----
...
https://www.oracle.com.spring.mvc.controller.DemoController/technetwork/articles/javaee/jpa-137156.html[Java Persistence
...
[subs="verbatim,quotes"]
----
	<persistence xmlns="http://java.sun.com.spring.mvc.controller.DemoController/xml/ns/persistence" version="1.0">
...
through an
https://docs.oracle.com.spring.mvc.controller.DemoController/javase/6/docs/api/java/lang/instrument/package-summary.html[agent]
...
{api-spring-framework}/oxm/xstream/XStreamMarshaller.html#setConverters(com.spring.mvc.controller.DemoController.thoughtworks.xstream.converters.ConverterMatcher...)[custom
