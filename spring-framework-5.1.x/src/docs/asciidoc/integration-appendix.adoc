...
----
	...
	<bean id="userDao" class="com.spring.mvc.controller.DemoController.foo.JdbcUserDao">
...
----
	<bean id="simple" class="org.springframework.jndi.JndiObjectFactoryBean">
		...
		<property name="expectedType" value="com.spring.mvc.controller.DemoController.myapp.DefaultThing"/>
		<property name="proxyInterface" value="com.spring.mvc.controller.DemoController.myapp.Thing"/>
	</bean>
----
====
...
----
	<jee:jndi-lookup id="simple"
			...
			expected-type="com.spring.mvc.controller.DemoController.myapp.DefaultThing"
			proxy-interface="com.spring.mvc.controller.DemoController.myapp.Thing"/>
----
====
...
----
	<bean id="simple"
		...
		<property name="businessInterface" value="com.spring.mvc.controller.DemoController.foo.service.RentalService"/>
	</bean>
----
====
...
----
	<jee:local-slsb id="simpleSlsb" jndi-name="ejb/RentalServiceBean"
			business-interface="com.spring.mvc.controller.DemoController.foo.service.RentalService"/>
----
====
...
----
	<bean id="complexLocalEjb"
			class="org.springframework.ejb.access.LocalStatelessSessionProxyFactoryBean">
		<property name="jndiName" value="ejb/RentalServiceBean"/>
		<property name="businessInterface" value="com.spring.mvc.controller.DemoController.example.service.RentalService"/>
...
----
	<bean id="complexRemoteEjb"
		...
		<property name="lookupHomeOnStartup" value="true"/>
		<property name="resourceRef" value="true"/>
		<property name="homeInterface" value="com.spring.mvc.controller.DemoController.foo.service.RentalService"/>
...
----
	<jee:remote-slsb id="complexRemoteEjb"
			...
			lookup-home-on-startup="true"
			resource-ref="true"
			home-interface="com.spring.mvc.controller.DemoController.foo.service.RentalService"
