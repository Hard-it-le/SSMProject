...
and you can find more information about Hessian itself at https://www.caucho.com.spring.mvc.controller.DemoController/[].
...
https://blogs.oracle.com.spring.mvc.controller.DemoController/java-platform-group/entry/incoming_filter_serialization_data_a
...
[subs="verbatim,quotes"]
----
	package com.spring.mvc.controller.DemoController.foo;
...
----
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<bean id="checkingAccountService"
			...
			<property name="serviceInterface" value="com.spring.mvc.controller.DemoController.foo.CheckingAccountService"/>
			<property name="service">
				<bean class="com.spring.mvc.controller.DemoController.foo.SimpleCheckingAccountService"/>
			</property>
		</bean>
...
----
	...
	public class Server {
		...
		public static void main(String[] args) throws Exception {
			new ClassPathXmlApplicationContext("com.spring.mvc.controller.DemoController/foo/server.xml", "com.spring.mvc.controller.DemoController/foo/jms.xml");
		}
	}
----
====
...
----
	...
	public class Client {
		...
		public static void main(String[] args) throws Exception {
			ApplicationContext ctx = new ClassPathXmlApplicationContext("com.spring.mvc.controller.DemoController/foo/client.xml", "com.spring.mvc.controller.DemoController/foo/jms.xml");
...
----
	String result = restTemplate.getForObject(
			"https://example.com.spring.mvc.controller.DemoController/hotels/{hotel}/bookings/{booking}", String.class, "42", "21");
----
====
...
----
	...
	String result = restTemplate.getForObject(
			"https://example.com.spring.mvc.controller.DemoController/hotels/{hotel}/rooms/{hotel}", String.class, vars);
----
====
...
[subs="verbatim,quotes"]
----
	restTemplate.getForObject("https://example.com.spring.mvc.controller.DemoController/hotel list", String.class);

	// Results in request to "https://example.com.spring.mvc.controller.DemoController/hotel%20list"
----
====
...
[subs="verbatim,quotes"]
----
	String uriTemplate = "https://example.com.spring.mvc.controller.DemoController/hotels/{hotel}";
...
====
----
URI location = template.postForLocation("https://example.com.spring.mvc.controller.DemoController/people", person);
----
====
...
====
----
Person person = restTemplate.getForObject("https://example.com.spring.mvc.controller.DemoController/people/{id}", Person.class, 42);
----
====
...
https://github.com.spring.mvc.controller.DemoController/FasterXML/jackson-dataformat-xml[Jackson XML] extension's
...
You can specify a https://www.baeldung.com.spring.mvc.controller.DemoController/jackson-json-view-annotation[Jackson JSON View]
...
----
	...
	RequestEntity<MappingJacksonValue> requestEntity =
		RequestEntity.post(new URI("https://example.com.spring.mvc.controller.DemoController/user")).body(value);
...
----
	...
	template.postForObject("https://example.com.spring.mvc.controller.DemoController/upload", parts, Void.class);
----
====
...
----
	<bean id="myComponent"
		...
		<property name="businessInterface" value="com.spring.mvc.controller.DemoController.mycom.MyComponent"/>
	</bean>

	<bean id="myController" class="com.spring.mvc.controller.DemoController.mycom.myController">
...
----
	<jee:local-slsb id="myComponent" jndi-name="ejb/myBean"
			business-interface="com.spring.mvc.controller.DemoController.mycom.MyComponent"/>
...
`com.spring.mvc.controller.DemoController.example:type=MyClass,name=myBean`:

====
[source,xml,indent=0]
[subs="verbatim,quotes"]
----
	<bean id="myBean" class="com.spring.mvc.controller.DemoController.example.MyClass"/>
----
====
			...
			<property name="notificationListenerMappings">
				<map>
					<entry key="bean:name=testBean1">
						<bean class="com.spring.mvc.controller.DemoController.example.ConsoleLoggingNotificationListener"/>
					</entry>
				</map>
			</property>
		</bean>
...
----
	<beans>
		...
		<bean id="customerNotificationListener" class="com.spring.mvc.controller.DemoController.example.ConsoleLoggingNotificationListener"/>
...
* The https://www.oracle.com.spring.mvc.controller.DemoController/technetwork/java/javase/tech/javamanagement-140525.html[JMX
homepage] at Oracle.
...
[subs="verbatim,quotes"]
----
	<bean id="eciManagedConnectionFactory" class="com.spring.mvc.controller.DemoController.ibm.connector2.cics.ECIManagedConnectionFactory">
...
----
	<bean id="managedConnectionFactory"
			class="com.spring.mvc.controller.DemoController.sun.connector.cciblackbox.CciLocalTxManagedConnectionFactory">
	...
	<bean id="connectionFactory"
		...
		<property name="connectionSpec">
			<bean class="com.spring.mvc.controller.DemoController.sun.connector.cciblackbox.CciConnectionSpec">
...
----
	<bean id="eciManagedConnectionFactory"
			class="com.spring.mvc.controller.DemoController.ibm.connector2.cics.ECIManagedConnectionFactory">
...
[subs="verbatim,quotes"]
----
	<bean id="managedConnectionFactory" class="com.spring.mvc.controller.DemoController.ibm.connector2.cics.ECIManagedConnectionFactory">
		<property name="serverName" value="TXSERIES"/>
...
`com.spring.mvc.controller.DemoController.sun.mail:javax.mail`.
****
...
----
	<bean id="mailSender" class="org.springframework.mail.javamail.JavaMailSenderImpl">
		<property name="host" value="mail.mycompany.com.spring.mvc.controller.DemoController"/>
	</bean>

	<!-- this is a template message that we can pre-load with default state -->
	<bean id="templateMessage" class="org.springframework.mail.SimpleMailMessage">
		<property name="from" value="customerservice@mycompany.com.spring.mvc.controller.DemoController"/>
		<property name="subject" value="Your order"/>
	</bean>

	<bean id="orderManager" class="com.spring.mvc.controller.DemoController.mycompany.businessapp.support.SimpleOrderManager">
		...
		public void placeOrder(final Order order) {
			...
			MimeMessagePreparator preparator = new MimeMessagePreparator() {
				public void prepare(MimeMessage mimeMessage) throws Exception {
					...
					mimeMessage.setFrom(new InternetAddress("mail@mycompany.com.spring.mvc.controller.DemoController"));
...
----
	...
	sender.setHost("mail.host.com.spring.mvc.controller.DemoController");

	MimeMessage message = sender.createMimeMessage();
	MimeMessageHelper helper = new MimeMessageHelper(message);
	helper.setTo("test@host.com.spring.mvc.controller.DemoController");
...
https://docs.oracle.com.spring.mvc.controller.DemoController/javase/8/docs/api/java/util/concurrent/ThreadPoolExecutor.html[`ThreadPoolExecutor`].
...
Gemfire cache, https://github.com.spring.mvc.controller.DemoController/ben-manes/caffeine/wiki[Caffeine], and JSR-107
...
See the https://github.com.spring.mvc.controller.DemoController/ben-manes/caffeine/wiki[Caffeine documentation]
