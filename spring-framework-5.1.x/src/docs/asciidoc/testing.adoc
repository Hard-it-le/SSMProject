...
or alternative Servlet API mock objects (such as http://www.mockobjects.com.spring.mvc.controller.DemoController[MockObjects]).
...
class. If your class is named `com.spring.mvc.controller.DemoController.example.MyTest`, `GenericXmlContextLoader` loads your
application context from `"classpath:com.spring.mvc.controller.DemoController/example/MyTest-context.xml"`. The following
...
[subs="verbatim,quotes"]
----
	package com.spring.mvc.controller.DemoController.example;

	@RunWith(SpringRunner.class)
	// ApplicationContext will be loaded from
	// "classpath:com.spring.mvc.controller.DemoController/example/MyTest-context.xml"
...
`com.spring.mvc.controller.DemoController.example.MyTest`, the Groovy context loader loads your application context from
`"classpath:com.spring.mvc.controller.DemoController/example/MyTestContext.groovy"`. The following example shows how to use
the default:
...
----
	...
	@RunWith(SpringRunner.class)
	// ApplicationContext will be loaded from
	// "classpath:com.spring.mvc.controller.DemoController/example/MyTestContext.groovy"
	@ContextConfiguration <1>
	public class MyTest {
		// class body...
	}
...
----
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<bean id="transferService"
				class="com.spring.mvc.controller.DemoController.bank.service.internal.DefaultTransferService">
			<constructor-arg ref="accountRepository"/>
			<constructor-arg ref="feePolicy"/>
		</bean>

		<bean id="accountRepository"
				class="com.spring.mvc.controller.DemoController.bank.repository.internal.JdbcAccountRepository">
			<constructor-arg ref="dataSource"/>
		</bean>

		<bean id="feePolicy"
			class="com.spring.mvc.controller.DemoController.bank.service.internal.ZeroFeePolicy"/>

		<beans profile="dev">
			<jdbc:embedded-database id="dataSource">
				<jdbc:script
					location="classpath:com.spring.mvc.controller.DemoController/bank/config/sql/schema.sql"/>
				<jdbc:script
					location="classpath:com.spring.mvc.controller.DemoController/bank/config/sql/test-data.sql"/>
...
[subs="verbatim,quotes"]
----
	package com.spring.mvc.controller.DemoController.bank.service;
...
[subs="verbatim,quotes"]
----
	package com.spring.mvc.controller.DemoController.bank.service.test;
...
`"classpath:/com.spring.mvc.controller.DemoController/example/test.properties"` or `"file:///path/to/file.xml"`.
...
if the annotated test class is `com.spring.mvc.controller.DemoController.example.MyTest`, the corresponding default properties
file is `classpath:com.spring.mvc.controller.DemoController/example/MyTest.properties`. If the default cannot be detected, an
...
----
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<bean id="titleRepository" class="com.spring.mvc.controller.DemoController.foo.repository.hibernate.HibernateTitleRepository">
...
----
	<beans>
		...
		<bean id="userService" class="com.spring.mvc.controller.DemoController.example.SimpleUserService"
				c:loginAction-ref="loginAction"/>

		<bean id="loginAction" class="com.spring.mvc.controller.DemoController.example.LoginAction"
...
----
	<beans>
		...
		<bean id="userPreferences" class="com.spring.mvc.controller.DemoController.example.UserPreferences"
...
* Class-level declaration: If the annotated test class is `com.spring.mvc.controller.DemoController.example.MyTest`, the
  corresponding default script is `classpath:com.spring.mvc.controller.DemoController/example/MyTest.sql`.
* Method-level declaration: If the annotated test method is named `testMethod()` and is
  defined in the class `com.spring.mvc.controller.DemoController.example.MyTest`, the corresponding default script is
  `classpath:com.spring.mvc.controller.DemoController/example/MyTest.testMethod.sql`.
...
supported. See these
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/tree/master/spring-test/src/test/java/org/springframework/test/web/servlet/samples/context[sample tests].
...
syntax is supported through the Jayway https://github.com.spring.mvc.controller.DemoController/jayway/JsonPath[JsonPath
...
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-hateoas[Spring HATEOAS], you can verify the
...
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/tree/master/spring-test/src/test/java/org/springframework/test/web/servlet/samples[many
sample tests] intended to show how to use Spring MVC Test. You can browse these examples
for further ideas. Also, the
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-mvc-showcase[`spring-mvc-showcase`] project has
...
----
	...
	public void setup() {
		webClient = MockMvcWebClientBuilder
			...
			// the following will use MockMvc for example.com.spring.mvc.controller.DemoController and example.org as well
			.useMockMvcForHosts("example.com.spring.mvc.controller.DemoController","example.org")
			.build();
	}
----
====
...
https://github.com.spring.mvc.controller.DemoController/SeleniumHQ/selenium/wiki/PageObjects[Page Object Pattern]. While we
...
https://github.com.spring.mvc.controller.DemoController/SeleniumHQ/selenium/wiki/PageFactory[`PageFactory`] lets us remove a
...
<3> We can use the
https://github.com.spring.mvc.controller.DemoController/SeleniumHQ/selenium/wiki/PageFactory#making-the-example-work-using-annotations[`@FindBy` annotation]
...
https://github.com.spring.mvc.controller.DemoController/SeleniumHQ/selenium/wiki/Getting-Started[WebDriver documentation].
...
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/tree/master/spring-test/src/test/java/org/springframework/test/web/client/samples[example
...
* http://www.mockobjects.com.spring.mvc.controller.DemoController/[MockObjects.com.spring.mvc.controller.DemoController]: Web site dedicated to mock objects, a
...
* https://mockito.github.io[Mockito]: Java mock library based on the
  http://xunitpatterns.com.spring.mvc.controller.DemoController/Test%20Spy.html[Test Spy] pattern.
