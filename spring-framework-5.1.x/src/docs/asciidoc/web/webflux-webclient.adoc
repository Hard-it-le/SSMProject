...
https://github.com.spring.mvc.controller.DemoController/reactor/reactor-netty[Reactor Netty], there is built-in support for
the Jetty https://github.com.spring.mvc.controller.DemoController/jetty-project/jetty-reactive-httpclient[reactive HttpClient],
...
https://github.com.spring.mvc.controller.DemoController/square/okhttp#mockwebserver[OkHttp MockWebServer]. To see an example
of its use, check out
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/blob/master/spring-webflux/src/test/java/org/springframework/web/reactive/function/client/WebClientIntegrationTests.java[`WebClientIntegrationTests`]
in the Spring Framework test suite or the
https://github.com.spring.mvc.controller.DemoController/square/okhttp/tree/master/samples/static-server[`static-server`]
