...
(https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/tree/master/spring-webmvc[spring-webmvc] and
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/tree/master/spring-webflux[spring-webflux])
...
https://github.com.spring.mvc.controller.DemoController/reactive-streams/reactive-streams-jvm/blob/master/README.md#specification[small spec]
(also https://docs.oracle.com.spring.mvc.controller.DemoController/javase/9/docs/api/java/util/concurrent/Flow.html[adopted] in Java 9)
...
https://github.com.spring.mvc.controller.DemoController/reactor/reactor[Reactor] is the reactive library of choice for
...
https://github.com.spring.mvc.controller.DemoController/reactor/reactor-netty[Reactor Netty] and for the reactive
https://github.com.spring.mvc.controller.DemoController/jetty-project/jetty-reactive-httpclient[Jetty HttpClient].
...
| Netty
| Netty API
| https://github.com.spring.mvc.controller.DemoController/reactor/reactor-netty[Reactor Netty]
...
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/wiki/What%27s-New-in-the-Spring-Framework[supported versions]):
...
https://github.com.spring.mvc.controller.DemoController/synchronoss/nio-multipart[Synchronoss NIO Multipart] is the only
...
JSON and binary JSON (https://github.com.spring.mvc.controller.DemoController/FasterXML/smile-format-specification[Smile]) are
...
https://github.com.spring.mvc.controller.DemoController/synchronoss/nio-multipart[Synchronoss NIO Multipart] is used for the
actual parsing.
...
`redirect:https://example.com.spring.mvc.controller.DemoController/arbitrary/path` redirects to an absolute URL.
...
https://www.baeldung.com.spring.mvc.controller.DemoController/jackson-json-view-annotation[Jackson's Serialization Views],
...
* https://fasterxml.github.io/jackson-databind/javadoc/2.6/com.spring.mvc.controller.DemoController/fasterxml/jackson/databind/DeserializationFeature.html#FAIL_ON_UNKNOWN_PROPERTIES[`DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES`] is disabled.
* https://fasterxml.github.io/jackson-databind/javadoc/2.6/com.spring.mvc.controller.DemoController/fasterxml/jackson/databind/MapperFeature.html#DEFAULT_VIEW_INCLUSION[`MapperFeature.DEFAULT_VIEW_INCLUSION`] is disabled.

It also automatically registers the following well-known modules if they are detected on the classpath:

* https://github.com.spring.mvc.controller.DemoController/FasterXML/jackson-datatype-jdk7[`jackson-datatype-jdk7`]: Support for Java 7 types like `java.nio.file.Path`.
* https://github.com.spring.mvc.controller.DemoController/FasterXML/jackson-datatype-joda[`jackson-datatype-joda`]: Support for Joda-Time types.
* https://github.com.spring.mvc.controller.DemoController/FasterXML/jackson-datatype-jsr310[`jackson-datatype-jsr310`]: Support for Java 8 Date and Time API types.
* https://github.com.spring.mvc.controller.DemoController/FasterXML/jackson-datatype-jdk8[`jackson-datatype-jdk8`]: Support for other Java 8 types, such as `Optional`.
...
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/wiki/HTTP-2-support[HTTP/2 wiki page].
