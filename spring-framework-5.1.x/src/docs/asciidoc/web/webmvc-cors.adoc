...
For example, you could have your bank account in one tab and evil.com.spring.mvc.controller.DemoController in another. Scripts
from evil.com.spring.mvc.controller.DemoController should not be able to make AJAX requests to your bank API with your
...
implemented by https://caniuse.com.spring.mvc.controller.DemoController/#feat=cors[most browsers] that lets you specify
...
[subs="verbatim,quotes"]
----
@CrossOrigin(origins = "https://domain2.com.spring.mvc.controller.DemoController", maxAge = 3600)
@RestController
@RequestMapping("/account")
public class AccountController {
...
public class AccountController {
	...
	@CrossOrigin("https://domain2.com.spring.mvc.controller.DemoController")
	@GetMapping("/{id}")
	public Account retrieve(@PathVariable Long id) {
		// ...
	}
...
public class WebConfig implements WebMvcConfigurer {
	...
	public void addCorsMappings(CorsRegistry registry) {
		...
		registry.addMapping("/api/**")
			.allowedOrigins("https://domain2.com.spring.mvc.controller.DemoController")
...
<mvc:cors>
	...
	<mvc:mapping path="/api/**"
		allowed-origins="https://domain1.com.spring.mvc.controller.DemoController, https://domain2.com.spring.mvc.controller.DemoController"
	...
	<mvc:mapping path="/resources/**"
		allowed-origins="https://domain1.com.spring.mvc.controller.DemoController" />
...
config.addAllowedOrigin("https://domain1.com.spring.mvc.controller.DemoController");
