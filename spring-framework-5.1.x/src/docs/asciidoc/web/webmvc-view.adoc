...
|https://handlebarsjs.com.spring.mvc.controller.DemoController/[Handlebars] |https://openjdk.java.net/projects/nashorn/[Nashorn]
...
|https://www.embeddedjs.com.spring.mvc.controller.DemoController/[EJS] |https://openjdk.java.net/projects/nashorn/[Nashorn]
|https://www.stuartellis.name/articles/erb/[ERB] |https://www.jruby.org[JRuby]
|https://docs.python.org/2/library/string.html#template-strings[String templates] |https://www.jython.org/[Jython]
|https://github.com.spring.mvc.controller.DemoController/sdeleuze/kotlin-script-templating[Kotlin Script templating] |https://kotlinlang.org/[Kotlin]
|===
...
* `org.jetbrains.kotlin:kotlin-script-util` dependency and a `META-INF/services/javax.script.ScriptEngineFactory`
 ...
 https://github.com.spring.mvc.controller.DemoController/sdeleuze/kotlin-script-templating[this example] for more details.
...
implements a custom render function. For example, https://handlebarsjs.com.spring.mvc.controller.DemoController[Handlerbars]
...
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/tree/master/spring-webmvc/src/test/java/org/springframework/web/servlet/view/script[Java], and
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/tree/master/spring-webmvc/src/test/resources/org/springframework/web/servlet/view/script[resources],
...
https://github.com.spring.mvc.controller.DemoController/FasterXML/jackson-dataformat-xml[Jackson XML extension's] `XmlMapper`
