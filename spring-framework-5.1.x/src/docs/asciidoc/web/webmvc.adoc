...
(https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/tree/master/spring-webmvc[`spring-webmvc`]),
...
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/wiki/Spring-Framework-Versions[Wiki].
...
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-framework/blob/master/spring-webmvc/src/main/resources/org/springframework/web/servlet/DispatcherServlet.properties[`DispatcherServlet.properties`].
...
Servlet context, while a name such as `redirect:https://myhost.com.spring.mvc.controller.DemoController/some/arbitrary/path`
...
https://github.com.spring.mvc.controller.DemoController/FasterXML/jackson-module-parameter-names[`jackson-module-parameter-names`],
...
* https://github.com.spring.mvc.controller.DemoController/FasterXML/jackson-datatype-jdk7[jackson-datatype-jdk7]: Support for Java 7 types, such as `java.nio.file.Path`.
...
* https://github.com.spring.mvc.controller.DemoController/zalando/jackson-datatype-money[jackson-datatype-money]: Support for `javax.money` types (unofficial module).
* https://github.com.spring.mvc.controller.DemoController/FasterXML/jackson-datatype-hibernate[jackson-datatype-hibernate]: Support for Hibernate-specific types and properties (including lazy-loading aspects).
...
----
	...
	<bean id="objectMapper" class="org.springframework.http.converter.json.Jackson2ObjectMapperFactoryBean"
		  ...
		  p:modulesToInstall="com.spring.mvc.controller.DemoController.fasterxml.jackson.module.paramnames.ParameterNamesModule"/>
