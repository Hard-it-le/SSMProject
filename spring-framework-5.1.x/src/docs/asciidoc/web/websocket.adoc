...
https://github.com.spring.mvc.controller.DemoController/eclipse-ee4j/websocket-api/issues/211[eclipse-ee4j/websocket-api#211].
...
----
	<web-app xmlns="http://java.sun.com.spring.mvc.controller.DemoController/xml/ns/javaee"
		xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
		xsi:schemaLocation="
			http://java.sun.com.spring.mvc.controller.DemoController/xml/ns/javaee
			https://java.sun.com.spring.mvc.controller.DemoController/xml/ns/javaee/web-app_3_0.xsd"
		version="3.0">
...
----
	...
	public class WebSocketConfig implements WebSocketConfigurer {
		...
		@Override
		public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
			registry.addHandler(myHandler(), "/myHandler").setAllowedOrigins("https://mydomain.com.spring.mvc.controller.DemoController");
		}
...
----
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<websocket:handlers allowed-origins="https://mydomain.com.spring.mvc.controller.DemoController">
			<websocket:mapping path="/myHandler" handler="myHandler" />
		</websocket:handlers>
...
* The https://github.com.spring.mvc.controller.DemoController/sockjs/sockjs-protocol[SockJS protocol]
defined in the form of executable
https://sockjs.github.io/sockjs-protocol/sockjs-protocol-0.3.3.html[narrated tests].
* The https://github.com.spring.mvc.controller.DemoController/sockjs/sockjs-client/[SockJS JavaScript client] -- a client library for use in browsers.
...
https://github.com.spring.mvc.controller.DemoController/sockjs/sockjs-client/[SockJS client] page. Transports
...
https://github.com.spring.mvc.controller.DemoController/sockjs/sockjs-client/[`sockjs-client`] (version 1.0.x). It
...
https://github.com.spring.mvc.controller.DemoController/sockjs/sockjs-client/[sockjs-client] page and the list of
...
https://blogs.msdn.com.spring.mvc.controller.DemoController/b/ieinternals/archive/2010/05/13/xdomainrequest-restrictions-limitations-and-workarounds.aspx[`XDomainRequest`].
...
https://github.com.spring.mvc.controller.DemoController/sockjs/sockjs-client/[SockJS client] page.
...
that has gone away. See https://github.com.spring.mvc.controller.DemoController/eclipse-ee4j/servlet-api/issues/44[eclipse-ee4j/servlet-api#44].
...
----
  ...
  sockJsClient.doHandshake(new MyWebSocketHandler(), "ws://example.com.spring.mvc.controller.DemoController:8080/sockjs");
----
====
...
https://github.com.spring.mvc.controller.DemoController/sockjs/sockjs-client[`sockjs-client`]. For STOMP, many applications have
used the https://github.com.spring.mvc.controller.DemoController/jmesnil/stomp-websocket[jmesnil/stomp-websocket] library
...
https://github.com.spring.mvc.controller.DemoController/JSteunou/webstomp-client[JSteunou/webstomp-client] is the most
...
* https://github.com.spring.mvc.controller.DemoController/rstoyanchev/spring-websocket-portfolio[Stock Portfolio] -- a sample
application.
...
https://www.rabbitmq.com.spring.mvc.controller.DemoController/stomp.html[RabbitMQ],
...
https://github.com.spring.mvc.controller.DemoController/spring-projects/spring-security-oauth[Spring Security OAuth]
...
https://github.com.spring.mvc.controller.DemoController/sockjs/sockjs-client/issues/196[sockjs-client issue 196].
...
(such as the JavaScript https://github.com.spring.mvc.controller.DemoController/JSteunou/webstomp-client[webstomp-client]
...
https://github.com.spring.mvc.controller.DemoController/rstoyanchev/spring-websocket-portfolio/tree/master/src/test/java/org/springframework/samples/portfolio/web[tests for the stock portfolio]
sample application.
...
The https://github.com.spring.mvc.controller.DemoController/rstoyanchev/spring-websocket-portfolio/tree/master/src/test/java/org/springframework/samples/portfolio/web[tests for the stock portfolio]
